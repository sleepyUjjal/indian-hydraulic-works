        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-4 text-[var(--text-secondary)] text-sm mb-6 lg:mb-0">
              <li>
                <a href="tel:+917942651152" className="hover:text-trust-blue transition-colors flex items-center gap-3">
                  ...
                  <span className="font-medium">+91 7942651152</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@hydraulicworks.com" className="hover:text-trust-blue transition-colors flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[var(--border-color)] flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-[var(--text-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span className="font-medium">info@hydraulicworks.com</span>
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="leading-relaxed">
                  ...
                  Plot No. 10, New A - 73, Kapra Colony, Behind Aggarwal Dhramshala, Air Force Road, NIT, Jawahar Colony Faridabad, Faridabad - 121005, Haryana, India
                </span>
              </li>
            </ul>
          </div>
